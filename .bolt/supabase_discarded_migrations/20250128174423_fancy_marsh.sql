...
BEGIN
  ...
  BEGIN
    ...
    -- Add delay to ensure business is created
    PERFORM pg_sleep(0.1);

    -- 2. Create user record with the business_id
    ...
    -- Add delay to ensure all data is created
    PERFORM pg_sleep(0.1);

    -- 6. Finally, update auth.users metadata
    UPDATE auth.users
