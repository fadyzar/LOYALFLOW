...
DROP FUNCTION IF EXISTS hash_customer_password_trigger_v2();
DROP FUNCTION IF EXISTS hash_customer_password_v2(text);
...
AS $$
BEGIN
  RETURN encode(sha256(p_password::bytea), 'hex');
END;
$$;
