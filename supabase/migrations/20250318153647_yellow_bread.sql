...
-- Create indexes
CREATE INDEX idx_business_chat_messages_business ON business_chat_messages(business_id);
CREATE INDEX idx_business_chat_messages_user ON business_chat_messages(user_id);
CREATE INDEX idx_business_chat_messages_month ON business_chat_messages(month_year);
