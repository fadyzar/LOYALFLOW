...
import { ServiceFormData, ServicePromotion } from '../types';
import { Calendar, Image as ImageIcon, Tag, Upload, X } from 'lucide-react';
...
export function ServiceForm({ formData, onFormChange, onSubmit, onCancel, isEditing, existingImageUrl }: ServiceFormProps) {
  ...
  const handlePromotionChange = (field: keyof ServicePromotion, value: any) => {
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-sm text-gray-500">יש להזין מספר דקות המתחלק ב-5</p>
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="תיאור אופציונלי של השירות"
